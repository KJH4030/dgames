...
<div class="container">
  ...
  <div class="box box-primary">
      ...
      <div class="form-group row">
        <label for="dgm_id" class="col-2">주문자</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_dgm_id" value="${loginStatus.dgm_id }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="dgm_name" class="col-2">이름</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_dgm_name" value="${loginStatus.dgm_name }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="dgm_email" class="col-2">전자우편</label>
        <div class="col-8">
          <input type="email" class="form-control" id="b_dgm_email" value="${loginStatus.dgm_email }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_postcode" class="col-2">우편번호</label>
        <div class="col-8">
          <input type="text" class="form-control" id="b_dgm_zipcode" value="${loginStatus.dgm_zipcode }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_address" class="col-2">기본주소</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_dgm_addr" value="${loginStatus.dgm_addr }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_detailAddress" class="col-2">상세주소</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_dgm_dtaddr" value="${loginStatus.dgm_dtaddr }" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="dgm_phone" class="col-2">전화번호</label>
        <div class="col-10">
          <input type="text" class="form-control" id="b_dgm_phone" value="${loginStatus.dgm_phone }" readonly>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="dgm_id" class="col-2">수령인(이름)</label>
        <div class="col-8">
          <input type="text" class="form-control" name="dgm_name" id="dgm_name" placeholder="이름 입력...">
        </div>
        <div class="col-2">
      ...
      <div class="form-group row">
        <label for="sample2_postcode" class="col-2">우편번호</label>
        <div class="col-8">
          <input type="text" class="form-control" name="dgm_zipcode" id="sample2_postcode" placeholder="우편번호...">
        </div>
        <div class="col-2">
      ...
      <div class="form-group row">
        <label for="sample2_address" class="col-2">기본주소</label>
        <div class="col-10">
          <input type="text" class="form-control" name="dgm_addr" id="sample2_address" placeholder="기본주소입력...">
        </div>
      </div>
      <div class="form-group row">
        <label for="sample2_detailAddress" class="col-2">상세주소</label>
        <div class="col-10">
          <input type="text" class="form-control" name="dgm_dtaddr" id="sample2_detailAddress" placeholder="상세주소입력...">
      ...
      <div class="form-group row">
        <label for="dgm_phone" class="col-2">전화번호</label>
        <div class="col-10">
          <input type="text" class="form-control" name="dgm_phone" id="dgm_phone" placeholder="전화번호입력...">
        </div>
      </div>
      </fieldset>
      ...
      <div class="form-group row">
        <label for="dgm_phone" class="col-2">결제방법</label>
        <div class="col-10">
      ...
      <div class="form-group row" id="nobank_info" style="display: none;">
        <label for="dgm_phone" class="col-2">무통장 입금정보</label>
        <div class="col-10">
          은행명 
  ...
  <script>
    ...
    $("#same").on("click", function() {
      ...
      if($("#same").is(":checked")) {
        ...
        $("#dgm_name").val($("#b_dgm_name").val());
        $("#sample2_postcode").val($("#b_dgm_zipcode").val());
        $("#sample2_address").val($("#b_dgm_addr").val());
        $("#sample2_detailAddress").val($("#b_dgm_dtaddr").val());
        $("#dgm_phone").val($("#b_dgm_phone").val());
      }else {
        $("#dgm_name").val("");
    ...
    $("#btn_order").on("click", function() {
      ...
      // console.log("ord_name", $("#dgm_name").val());
      // console.log("ord_zipcode", $("input[name='dgm_zipcode']").val());
      // console.log("ord_addr_basic", $("input[name='dgm_addr']").val());
      // console.log("ord_addr_detail", $("input[name='dgm_dtaddr']").val());
      // console.log("ord_tel", $("#dgm_phone").val());
      ...
      if(paymethod === 'kakaopay') {
        $.ajax({
          url: '/member/order/orderPay',
          type: 'get',
          data: {
            paymethod : $("input[name='paymethod']:checked").val(),
            ord_name: $("#dgm_name").val(),
            ord_zipcode: $("input[name='dgm_zipcode']").val(),
            ord_addr_basic: $("input[name='dgm_addr']").val(),
            ord_addr_detail: $("input[name='dgm_dtaddr']").val(),
            ord_tel: $("#dgm_phone").val(),
      ...
      $.ajax({
          ...
          success : function(result) {
            ...
            if(result == 'success') {
              alert("무통장입금으로 주문이 완료가 되었습니다.");
              location.href = '/member/order/orderComplete';
            }
          }
