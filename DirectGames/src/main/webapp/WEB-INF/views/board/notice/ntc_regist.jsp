    		...
    		<div class="col-md-12">
    			<div class="box box-primary">
					...
					<form role="form" method="post" action="/board/notice/ntc_regist">
						...
						<input type="text" class="form-control" name="ntc_title" id="ntc_title" placeholder="제목 입력...">
						</div>
						<div class="form-group">
						<label>내용</label>
						<textarea class="form-control" rows="3" name="ntc_content" id="ntc_content" placeholder="내용입력...."></textarea>
						</div>
						</div>
