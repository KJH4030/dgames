...
## 1. Front-end
>  HTML5 / CSS / javascript / jQuery / Ajax / JSP

## 2. Back-end
> Java / Spring / MyBatis 등
...
# 📝 개발 후기
> 쇼핑몰은 사용자가 편하기 위한 목적도 있지만, 사이트 운영자가 관리하기 편하게 제작하는데 중점을 두어 설계했습니다.  
> 개발하는 과정에서 생각했던대로 기능이 작동하지 않거나, 도저히 해결하지 못할 것 같았던 버그들도 많았습니다.  
> 하지만 그런 버그들을 하나하나 해결해 나가는 과정에서 큰 즐거움을 느낄 수 있었고,  
> 단순히 일하는 작업이 아닌 스스로를 발전시켜나간다는 보람을 느낄 수 있었기에 웹개발이라는 분야에 더더욱 흥미와 확신을 가질 수 있는 시간이었다고 생각합니다.  
